...
import { 
  ...
  Layers, Lock, ZapOff, MousePointer2, Building2, Briefcase, Landmark
} from 'lucide-react';
...
import { StockCard3D } from './ThreeDAssets';

export default function StocksPage({ onBack, onStartTrading }: StocksPageProps) {
  ...
  const assets = [
    { 
      ...
      ticker: "AAPL", 
      icon: Building2,
      desc: "The world's most valuable technology company. A cornerstone of modern portfolios.",
      color: "#f97316",
      price: "182.41"
    },
    { 
      ...
      ticker: "TSLA", 
      icon: Zap,
      desc: "Leading the transition to sustainable energy. High volatility, high potential.",
      color: "#E31937",
      price: "175.22"
    },
    { 
      ...
      ticker: "NVDA", 
      icon: Cpu,
      desc: "The engine of the AI revolution. Unprecedented growth in the semiconductor space.",
      color: "#76B900",
      price: "875.33"
    },
    { 
      ...
      ticker: "MSFT", 
      icon: Globe,
      desc: "A software giant reinventing itself through cloud computing and AI integration.",
      color: "#00A4EF",
      price: "415.10"
    }
  ];
            ...
            <div className="lg:col-span-7 space-y-12">
              ...
              >
                ...
                <h1 className="text-7xl md:text-[120px] font-black tracking-tighter leading-[0.85] uppercase">
                  Global <br />
                  <span className="text-orange-500">Stocks.</span>
                </h1>
                <p className="text-2xl text-white/40 max-w-xl leading-snug font-medium italic serif">
                  "Own the future. Trade the world's most influential companies with institutional-grade tools and real-time market depth."
                </p>
              </motion.div>
      ...
      <section className="py-32 px-6 bg-[#050505] relative z-10">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24">
            ...
            <h3 className="text-6xl md:text-8xl font-black tracking-tighter uppercase">Blue <br /> <span className="text-orange-500">Chips.</span></h3>
          </div>
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  <StockCard3D 
                    ...
                    symbol={assets[activeAsset].ticker}
                    price={assets[activeAsset].price}
                    size="w-80 h-[400px]" 
                  />
                </motion.div>
              </AnimatePresence>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            <div className="lg:col-span-4 space-y-8">
              ...
              <h3 className="text-5xl font-black tracking-tighter uppercase">Equity <br /> <span className="text-white/20">Pulse.</span></h3>
              <p className="text-white/40 leading-relaxed italic serif">
                "Direct connection to global stock exchanges. Every trade, every quote, delivered with zero-compromise speed."
              </p>
            </div>
            ...
            <div className="lg:col-span-8">
              <div className="bg-black rounded-3xl border border-white/5 overflow-hidden shadow-2xl">
                <div className="flex items-center justify-between px-6 py-4 bg-white/5 border-b border-white/5">
                  ...
                  <div className="text-[10px] font-mono text-white/40 uppercase tracking-widest">StockX_Terminal_v4.0.1</div>
                </div>
                <div className="p-8 font-mono text-xs space-y-4 max-h-[400px] overflow-y-auto scrollbar-hide">
                  {[
                    { time: "14:29:01", type: "INFO", msg: "Initializing NYSE/NASDAQ connection..." },
                    { time: "14:29:02", type: "SUCCESS", msg: "Connection established. Latency: 0.15ms" },
                    { time: "14:29:05", type: "TRADE", msg: "AAPL: Institutional buy order detected at $182.41 (120K shares)" },
                    { time: "14:29:08", type: "INFO", msg: "Updating order book for TSLA..." },
                    { time: "14:29:12", type: "ALERT", msg: "Earnings report released for NVDA. Volatility increasing." },
                    { time: "14:29:15", type: "TRADE", msg: "MSFT: Sell order filled at $415.10 (45K shares)" },
                    { time: "14:29:20", type: "INFO", msg: "Syncing global equity pools..." },
                    { time: "14:29:25", type: "SUCCESS", msg: "Portfolio rebalanced. Current exposure: 35% Tech, 15% Energy" },
                  ].map((log, i) => (
              ...
              <div className="h-[500px] w-full bg-white/5 backdrop-blur-xl rounded-3xl border border-white/10 p-8 shadow-2xl relative group">
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={[
                    ...
                    { time: '04:00', value: 175 },
                    { time: '08:00', value: 172 },
                    { time: '12:00', value: 180 },
                    { time: '16:00', value: 185 },
                    { time: '20:00', value: 182 },
