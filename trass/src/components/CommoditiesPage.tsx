...
import { 
  ...
  Layers, Lock, ZapOff, MousePointer2, Flame, Droplets, Gem
} from 'lucide-react';
...
import { GoldBar3D } from './ThreeDAssets';

export default function CommoditiesPage({ onBack, onStartTrading }: CommoditiesPageProps) {
  ...
  const assets = [
    { 
      ...
      ticker: "XAU", 
      icon: Gem,
      desc: "The ultimate store of value. Trade the world's most precious metal with institutional precision.",
      color: "#f97316"
    },
    { 
      name: "Crude Oil", 
      ticker: "WTI", 
      icon: Droplets,
      desc: "The lifeblood of the global economy. Navigate the volatility of energy markets.",
      color: "#333333"
    },
    { 
      name: "Silver", 
      ticker: "XAG", 
      icon: Flame,
      desc: "A versatile industrial and precious metal. Experience high volatility and unique market drivers.",
      color: "#C0C0C0"
    },
    { 
      name: "Natural Gas", 
      ticker: "NG", 
      icon: Activity,
      desc: "A critical energy resource. Trade the seasonal and geopolitical shifts in gas prices.",
      color: "#00A4EF"
    }
  ];
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-7 space-y-12">
              ...
              >
                ...
                <h1 className="text-7xl md:text-[120px] font-black tracking-tighter leading-[0.85] uppercase">
                  Hard <br />
                  <span className="text-orange-500">Assets.</span>
                </h1>
                <p className="text-2xl text-white/40 max-w-xl leading-snug font-medium italic serif">
                  "Trade the foundation of civilization. Access the world's most critical commodities with institutional-grade precision."
                </p>
              </motion.div>
            ...
            <div className="lg:col-span-5 flex justify-center items-center relative">
              <GoldBar3D color={assets[0].color} />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-32 px-6 bg-[#050505] relative z-10">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24">
            ...
            <h3 className="text-6xl md:text-8xl font-black tracking-tighter uppercase">Real <br /> <span className="text-orange-500">Value.</span></h3>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            <div className="lg:col-span-4 space-y-8">
              ...
              <h3 className="text-5xl font-black tracking-tighter uppercase">Commodity <br /> <span className="text-white/20">Pulse.</span></h3>
              <p className="text-white/40 leading-relaxed italic serif">
                "Direct connection to global commodity exchanges. Every trade, every quote, delivered with zero-compromise speed."
              </p>
            </div>
            ...
            <div className="lg:col-span-8">
              <div className="bg-black rounded-3xl border border-white/5 overflow-hidden shadow-2xl">
                <div className="flex items-center justify-between px-6 py-4 bg-white/5 border-b border-white/5">
                  ...
                  <div className="text-[10px] font-mono text-white/40 uppercase tracking-widest">CommodityX_Terminal_v4.0.1</div>
                </div>
                <div className="p-8 font-mono text-xs space-y-4 max-h-[400px] overflow-y-auto scrollbar-hide">
                  {[
                    { time: "14:29:01", type: "INFO", msg: "Initializing LME/COMEX connection..." },
                    { time: "14:29:02", type: "SUCCESS", msg: "Connection established. Latency: 0.18ms" },
                    { time: "14:29:05", type: "TRADE", msg: "Gold: Institutional buy order detected at $2,150.40 (500kg)" },
                    { time: "14:29:08", type: "INFO", msg: "Updating order book for WTI Crude..." },
                    { time: "14:29:12", type: "ALERT", msg: "OPEC+ announcement detected. Volatility increasing." },
                    { time: "14:29:15", type: "TRADE", msg: "Silver: Sell order filled at $24.10 (2000oz)" },
                    { time: "14:29:20", type: "INFO", msg: "Syncing global commodity pools..." },
                    { time: "14:29:25", type: "SUCCESS", msg: "Inventory rebalanced. Current exposure: 40% Metals, 30% Energy" },
                  ].map((log, i) => (
              ...
              <div className="h-[500px] w-full bg-white/5 backdrop-blur-xl rounded-3xl border border-white/10 p-8 shadow-2xl relative group">
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={[
                    ...
                    { time: '08:00', value: 2020 },
                    { time: '12:00', value: 2100 },
                    { time: '16:00', value: 2150 },
                    { time: '20:00', value: 2120 },
                    { time: '24:00', value: 2200 },
                  ]}>
                    <defs>
