  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-4 bg-white/3 backdrop-blur-xl border border-white/5 p-3 rounded-2xl shadow-2xl">
          <div className="flex -space-x-3">
            {[1, 2, 3].map(i => (
              <div key={i} className="w-10 h-10 rounded-full border-2 border-[#0a0a0a] bg-linear-to-br from-orange-500/20 to-orange-500/5 flex items-center justify-center text-xs font-bold text-orange-500">
          ...
          <div className="pr-2">
            <p className="text-[10px] text-white/20 uppercase font-mono tracking-widest leading-none mb-1.5">System Status</p>
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse shadow-[0_0_10px_rgba(34,197,94,0.5)]" />
              <span className="text-[10px] font-bold font-mono text-green-500 uppercase tracking-widest">Operational</span>
            </div>
          </div>
        </div>
      </motion.div>
        ...
        >
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-[10px] text-white/40 font-mono uppercase tracking-[0.3em] mt-1">Live Institutional Data</p>
            </div>
            <div className="flex gap-2">
              <button className="p-2 bg-white/5 rounded-xl border border-white/5 hover:bg-white/10 transition-colors">
          ...
          <div className="space-y-3">
            {assets.slice(0, 10).map((asset, i) => {
              ...
              return (
                <div key={i} className="flex items-center justify-between p-4 bg-white/2 border border-white/5 rounded-2xl hover:bg-white/5 hover:border-white/10 transition-all duration-300 group cursor-pointer">
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 bg-white/5 rounded-xl flex items-center justify-center p-2.5 group-hover:bg-white/10 transition-all duration-500">
                    ...
                    <div>
                      <p className="text-sm font-bold group-hover:text-orange-500 transition-colors">{asset.name}</p>
                      <p className="text-[10px] text-white/20 font-mono uppercase tracking-widest">{asset.type}</p>
                    </div>
                  </div>
                  <div className="text-right space-y-1">
                    ...
                    <div className={cn(
                      "flex items-center justify-end gap-1 text-[10px] font-mono font-bold",
          ...
          <button className="w-full mt-8 py-4 bg-white/5 border border-white/10 rounded-2xl text-xs font-bold uppercase tracking-[0.2em] hover:bg-orange-500 hover:text-black hover:border-orange-500 transition-all duration-500 flex items-center justify-center gap-2 group">
            Explore All Markets
