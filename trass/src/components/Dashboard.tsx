  ...
  return (
    ...
    >
      ...
      >
        ...
        <div>
          <h1 className="text-3xl font-bold tracking-tighter uppercase">Rubicon</h1>
          <p className="text-white/40 text-xs font-mono tracking-widest uppercase">Digital Asset Platform</p>
        </div>
      </motion.div>
